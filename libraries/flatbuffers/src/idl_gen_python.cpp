...
namespace python {
    ...
    public:
            ...
            std::string* code_ptr) const
        {
            ...
            code += "):";
            if (!IsArray(field.value.type)) {
                code += GenIndents(2) + "o = flatbuffers.number_types.UOffsetTFlags.py_type" + "(self._tab.Offset(" + NumToString(field.value.offset) + "))";
            ...
            const size_t offset, std::string* code_ptr) const
        {
            ...
            if (!parser_.opts.one_file) {
                ...
                code += Indent + "return " + namer_.Type(struct_def) + "Add" + field_method;
                code += "(builder, ";
                code += field_var;
                code += ")\n";
            }
            ...
            std::set<std::string>* import_typing_list) const
        {
            ...
            if (base_type == BASE_TYPE_STRUCT) {
                const std::string object_type = namer_.ObjectType(*vector_type.struct_def);
                ...
                field_type = "List[" + GetBasePythonTypeForScalarAndString(base_type) + "]";
            }
        }
            ...
            std::set<std::string>* import_list) const
        {
            ...
            for (auto it = struct_def.fields.vec.begin();
                ...
                code += GenIndents(2) + "self." + field_field + " = " + default_value + "  # type: " + field_type;
            }
            ...
            std::string* code_ptr) const
        {
            ...
            code += ") is not None:";
            code += GenIndents(3) + "self." + field_field + " = " + namer_.ObjectType(field_type) + +".InitFromObj(" + struct_var + "." + field_method + "(";
            ...
            std::string* code_ptr) const
        {
            ...
            code += GenIndents(2) + "self." + field_field + " = " + union_type + "Creator(" + "self." + field_field + "Type, " + struct_var + "." + field_method + "())";
        }
            ...
            std::string* code_ptr) const
        {
            ...
            code += GenIndents(2) + "if not " + struct_var + "." + field_method + "IsNone():";
            code += GenIndents(3) + "self." + field_field + " = []";
            code += GenIndents(3) + "for i in range(" + struct_var + "." + field_method + "Length()):";
            ...
            code += GenIndents(4) + "if " + struct_var + "." + field_method + "(i) is None:";
            code += GenIndents(5) + "self." + field_field + ".append(None)";
            code += GenIndents(4) + "else:";
            code += GenIndents(5) + one_instance + " = " + namer_.ObjectType(field_type) + ".InitFromObj(" + struct_var + "." + field_method + "(i))";
            code += GenIndents(5) + "self." + field_field + ".append(" + one_instance + ")";
        }
            ...
            int indents) const
        {
            ...
            code += GenIndents(indents) + "for i in range(" + struct_var + "." + field_method + "Length()):";
            code += GenIndents(indents + 1) + "self." + field_field + ".append(" + struct_var + "." + field_method + "(i))";
        }
            ...
            std::string* code_ptr) const
        {
            ...
            code += GenIndents(4) + "self." + field_field + " = " + struct_var + "." + field_method + "AsNumpy()";
        }
            ...
            std::string* code_ptr) const
        {
            ...
            code += GenIndents(2) + "self." + field_field + " = " + struct_var + "." + field_method + "()";
        }
            ...
            std::string* code_ptr) const
        {
            ...
            if (field.value.type.struct_def->fixed) {
                code_prefix += GenIndents(3) + struct_type + "Start" + field_method + "Vector(builder, len(self." + field_field + "))";
                code_prefix += GenIndents(3) + "for i in reversed(range(len(self." + field_field + "))):";
                code_prefix += GenIndents(4) + "self." + field_field + "[i].Pack(builder)";
                ...
                code_prefix += GenIndents(4) + field_field + "list.append(self." + field_field + "[i].Pack(builder))";

                code_prefix += GenIndents(3) + struct_type + "Start" + field_method + "Vector(builder, len(self." + field_field + "))";
                code_prefix += GenIndents(3) + "for i in reversed(range(len(self." + field_field + "))):";
                code_prefix += GenIndents(4) + "builder.PrependUOffsetTRelative" + "(" + field_field + "list[i])";
                code_prefix += GenIndents(3) + field_field + " = builder.EndVector()";
            }

            // Adds the field into the struct.
            code += GenIndents(2) + "if self." + field_field + " is not None:";
            code += GenIndents(3) + struct_type + "Add" + field_method + "(builder, " + field_field + ")";
        }
            ...
            int indents) const
        {
            ...
            code += GenIndents(indents) + struct_type + "Start" + field_method + "Vector(builder, len(self." + field_field + "))";
            code += GenIndents(indents) + "for i in reversed(range(len(self." + field_field + "))):";
            ...
            std::string* code_ptr) const
        {
            ...
            if (IsString(vectortype)) {
                ...
                code_prefix += GenIndents(4) + field_field + "list.append(builder.CreateString(self." + field_field + "[i]))";
            ...
            code_prefix += GenIndents(3) + "if np is not None and type(self." + field_field + ") is np.ndarray:";
            code_prefix += GenIndents(4) + field_field + " = builder.CreateNumpyVector(self." + field_field + ")";
            ...
            std::string* code_ptr) const
        {
            ...
            if (field.value.type.struct_def->fixed) {
                ...
                // structs.
                code += GenIndents(2) + "if self." + field_field + " is not None:";
                code += GenIndents(3) + field_field + " = self." + field_field + ".Pack(builder)";
            } else {
                // Tables need to be created before their parent structs are created.
                code_prefix += GenIndents(2) + "if self." + field_field + " is not None:";
                code_prefix += GenIndents(3) + field_field + " = self." + field_field + ".Pack(builder)";
                code += GenIndents(2) + "if self." + field_field + " is not None:";
            }
            ...
            std::string* code_ptr) const
        {
            ...
            for (auto it = struct_def.fields.vec.begin();
                ...
                case BASE_TYPE_STRING: {
                    code_prefix += GenIndents(2) + "if self." + field_field + " is not None:";
                    code_prefix += GenIndents(3) + field_field + " = builder.CreateString(self." + field_field + ")";
                    code += GenIndents(2) + "if self." + field_field + " is not None:";
                    code += GenIndents(3) + struct_type + "Add" + field_method + "(builder, " + field_field + ")";
                    break;
                }
                default:
                    ...
                    code += GenIndents(2) + struct_type + "Add" + field_method + "(builder, self." + field_field + ")";
                    break;
                }
            }
            ...
            std::string* code_ptr) const
        {
            ...
            code += GenIndents(1) + "if unionType == " + union_type + "()." + variant + ":";
            if (parser_.opts.include_dependence_headers) {
                auto package_reference = GenPackageReference(ev.union_type);
                code += GenIndents(2) + "import " + package_reference;
                field_type = package_reference + "." + field_type;
            }
            code += GenIndents(2) + "return " + field_type + ".InitFromBuf(table.Bytes, table.Pos)";
        }
        ...
        std::string GenGetter(const Type& type) const
        {
            ...
            default:
                return "self._tab.Get(flatbuffers.number_types." + namer_.Method(GenTypeGet(type)) + "Flags, ";
            }
        }
    ...
    private:
            ...
            const std::string& classcode, bool needs_imports) const
        {
            ...
            const std::string directories = parser_.opts.one_file ? path_ : namer_.Directories(ns.components);
            EnsureDirExists(directories);

            for (size_t i = path_.size() + 1; i != std::string::npos;
                 i = directories.find(kPathSeparator, i + 1)) {
                const std::string init_py = directories.substr(0, i) + kPathSeparator + "__init__.py";
