...
static bool IsVectorOfPointers(const FieldDef& field)
{
    ...
    return type.base_type == BASE_TYPE_VECTOR && vector_type.base_type == BASE_TYPE_STRUCT && !vector_type.struct_def->fixed && !field.native_inline;
}

static bool IsPointer(const FieldDef& field)
{
    return field.value.type.base_type == BASE_TYPE_STRUCT && !IsStruct(field.value.type);
}

namespace cpp {

    enum CppStandard { CPP_STD_X0 = 0,
        CPP_STD_11,
        CPP_STD_17 };
    ...
    public:
        ...
        {
            code_ += "// Ensure the included flatbuffers.h is the same version as when this "
                     "file was";
            code_ += "// generated, otherwise it may not be compatible.";
            code_ += "static_assert(FLATBUFFERS_VERSION_MAJOR == " + std::to_string(FLATBUFFERS_VERSION_MAJOR) + " &&";
            code_ += "              FLATBUFFERS_VERSION_MINOR == " + std::to_string(FLATBUFFERS_VERSION_MINOR) + " &&";
            code_ += "              FLATBUFFERS_VERSION_REVISION == " + std::to_string(FLATBUFFERS_VERSION_REVISION) + ",";
        ...
        void GenIncludeDependencies()
        {
            ...
            for (const IncludedFile& included_file : included_files) {
                ...
                // the .fbs extension.
                const std::string name_without_ext = StripExtension(included_file.schema_name);
                ...
                const std::string basename = opts_.keep_prefix ? name_without_ext : StripPath(name_without_ext);

                code_ += "#include \"" + GeneratedFileName(opts_.include_prefix, basename, opts_) + "\"";
            }
        ...
        bool generate_bfbs_embed()
        {
            ...
            const auto file_path = GeneratedFileName(path_, file_name_ + "_bfbs", opts_);
        ...
        bool generate()
        {
            ...
            if (parser_.root_struct_def_) {
                ...
                code_ += "inline \\";
                code_ += "const {{CPP_NAME}} *{{NULLABLE_EXT}}Get{{STRUCT_NAME}}(const void "
                         "*buf) {";
                ...
                if (parser_.file_identifier_.length()) {
                    ...
                    code_ += "inline \\";
                    code_ += "bool SizePrefixed{{STRUCT_NAME}}BufferHasIdentifier(const void "
                             "*buf) {";
                    code_ += "  return ::flatbuffers::BufferHasIdentifier(";
            ...
            return SaveFile(file_path.c_str(), final_code, false) && (!parser_.opts.binary_schema_gen_embed || generate_bfbs_embed());
        }
    ...
    private:
        ...
        static std::string TranslateNameSpace(const std::string& qualified_name)
        {
            ...
            size_t start_pos = 0;
            while ((start_pos = cpp_qualified_name.find('.', start_pos)) != std::string::npos) {
        ...
        {
            return (opts_.scoped_enums && IsEnum(type)) || (opts_.g_cpp_std >= cpp::CPP_STD_17 && opts_.g_only_fixed_enums && IsEnum(type));
        }
            ...
            bool user_facing_type)
        {
            if (IsScalar(type.base_type)) {
                ...
                return beforeptr + (IsScalar(element_type.base_type) ? GenTypeBasic(element_type, user_facing_type) : GenTypePointer(element_type)) + afterptr;
            } else {
        ...
        {
            return "bool Verify" + Name(enum_def) + "(::flatbuffers::Verifier &verifier, const void *obj, " + Name(enum_def) + " type)";
        }
        ...
        std::string UnionVectorVerifySignature(const EnumDef& enum_def)
        {
            ...
            return "bool Verify" + name + "Vector" + "(::flatbuffers::Verifier &verifier, " + "const ::flatbuffers::Vector<::flatbuffers::Offset<void>> "
                                                                                              "*values, "
        ...
        {
            return (inclass ? "static " : "") + std::string("void *") + (inclass ? "" : Name(enum_def) + "Union::") + "UnPack(const void *obj, " + Name(enum_def) + " type, const ::flatbuffers::resolver_function_t *resolver)";
        }

        std::string UnionPackSignature(const EnumDef& enum_def, bool inclass)
        {
            return "::flatbuffers::Offset<void> " + (inclass ? "" : Name(enum_def) + "Union::") + "Pack(::flatbuffers::FlatBufferBuilder &_fbb, " + "const ::flatbuffers::rehasher_function_t *_rehasher" + (inclass ? " = nullptr" : "") + ") const";
        }

        std::string TableCreateSignature(const StructDef& struct_def, bool predecl,
            const IDLOptions& opts)
        {
            return "::flatbuffers::Offset<" + Name(struct_def) + "> Create" + Name(struct_def) + "(::flatbuffers::FlatBufferBuilder &_fbb, const " + NativeName(Name(struct_def), &struct_def, opts) + " *_o, const ::flatbuffers::rehasher_function_t *_rehasher" + (predecl ? " = nullptr" : "") + ")";
        }

        std::string TablePackSignature(const StructDef& struct_def, bool inclass,
            const IDLOptions& opts)
        {
            return std::string(inclass ? "static " : "") + "::flatbuffers::Offset<" + Name(struct_def) + "> " + (inclass ? "" : Name(struct_def) + "::") + "Pack(::flatbuffers::FlatBufferBuilder &_fbb, " + "const " + NativeName(Name(struct_def), &struct_def, opts) + "* _o, " + "const ::flatbuffers::rehasher_function_t *_rehasher" + (inclass ? " = nullptr" : "") + ")";
        }

        std::string TableUnPackSignature(const StructDef& struct_def, bool inclass,
            const IDLOptions& opts)
        {
            return NativeName(Name(struct_def), &struct_def, opts) + " *" + (inclass ? "" : Name(struct_def) + "::") + "UnPack(const ::flatbuffers::resolver_function_t *_resolver" + (inclass ? " = nullptr" : "") + ") const";
        }

        std::string TableUnPackToSignature(const StructDef& struct_def, bool inclass,
            const IDLOptions& opts)
        {
            return "void " + (inclass ? "" : Name(struct_def) + "::") + "UnPackTo(" + NativeName(Name(struct_def), &struct_def, opts) + " *" + "_o, const ::flatbuffers::resolver_function_t *_resolver" + (inclass ? " = nullptr" : "") + ") const";
        }
        ...
        void GenMiniReflect(const StructDef* struct_def, const EnumDef* enum_def)
        {
            ...
            auto num_fields = struct_def ? struct_def->fields.vec.size() : enum_def->size();
            ...
            for (auto& type : types) {
                ...
                ts += "{ ::flatbuffers::" + std::string(ElementaryTypeNames()[et]) + ", " + NumToString(is_vector || is_array) + ", " + NumToString(ref_idx) + " }";
            }
            std::string rs;
            ...
            std::string vs;
            const auto consecutive_enum_from_zero = enum_def && enum_def->MinValue()->IsZero() && ((enum_def->size() - 1) == enum_def->Distance());
            ...
            auto has_names = num_fields && opts_.mini_reflect == IDLOptions::kTypesAndNames;
            if (has_names) {
            ...
            code_ += std::string("    ::flatbuffers::{{SEQ_TYPE}}, {{NUM_FIELDS}}, ") + (num_fields ? "type_codes, " : "nullptr, ") + (!type_refs.empty() ? "type_refs, " : "nullptr, ") + (!as.empty() ? "array_sizes, " : "nullptr, ") + (!vs.empty() ? "values, " : "nullptr, ") + (has_names ? "names" : "nullptr");
            code_ += "  };";
            code_ += "  return &tt;";
            code_ += "}";
            code_ += "";
        ...
        void GenEnum(const EnumDef& enum_def)
        {
            ...
            code_ += (opts_.scoped_enums ? "enum class " : "enum ") + Name(enum_def) + "\\";
        ...
        void GenEnumObjectBasedAPI(const EnumDef& enum_def)
        {
            ...
            code_ += "    { {{NAME}}Union t(u); std::swap(type, t.type); std::swap(value, "
                     "t.value); return *this; }";
            code_ += "  {{NAME}}Union &operator=({{NAME}}Union &&u) FLATBUFFERS_NOEXCEPT";
            code_ += "    { std::swap(type, u.type); std::swap(value, u.value); return "
                     "*this; }";
        ...
        void GenEnumStringTable(const EnumDef& enum_def)
        {
            ...
            if (range / static_cast<uint64_t>(enum_def.size()) < kMaxSparseness) {
                ...
                code_ += "  static const char * const names[" + NumToString(range + 1 + 1) + "] = {";
                ...
                code_ += "  if (::flatbuffers::IsOutRange(e, " + GetEnumValUse(enum_def, *enum_def.MinValue()) + ", " + GetEnumValUse(enum_def, *enum_def.MaxValue()) + ")) return \"\";";
                ...
                code_ += "  switch (e) {";
                for (const auto& ev : enum_def.Vals()) {
                    code_ += "    case " + GetEnumValUse(enum_def, *ev) + ": return \"" + Name(*ev) + "\";";
                }
        ...
        void GenUnionPost(const EnumDef& enum_def)
        {
            ...
            for (auto it = enum_def.Vals().begin(); it != enum_def.Vals().end(); ++it) {
                ...
                if (ev.IsNonZero()) {
                    ...
                    code_ += "    case {{LABEL}}: {";
                    auto getptr = "      auto ptr = reinterpret_cast<const {{TYPE}} *>(obj);";
                    if (ev.union_type.base_type == BASE_TYPE_STRUCT) {
            ...
            if (opts_.generate_object_based_api) {
                ...
                for (auto it = enum_def.Vals().begin(); it != enum_def.Vals().end();
                    ...
                    if (ev.union_type.base_type == BASE_TYPE_STRUCT) {
                        if (ev.union_type.struct_def->fixed) {
                            code_ += "      return new " + WrapInNameSpace(*ev.union_type.struct_def) + "(*ptr);";
                        } else {
                ...
                for (const auto& ev : enum_def.Vals()) {
                    ...
                    code_ += "    case {{LABEL}}: {";
                    bool copyable = true;
                    if (opts_.g_cpp_std < cpp::CPP_STD_11 && ev->union_type.base_type == BASE_TYPE_STRUCT && !ev->union_type.struct_def->fixed) {
                        ...
                        for (const auto& field : ev->union_type.struct_def->fields.vec) {
                            if (!field->deprecated && field->value.type.struct_def && !field->native_inline) {
                                copyable = false;
                                break;
                            }
                        }
            ...
            const std::string& val)
        {
            if (from && field.value.type.base_type == BASE_TYPE_BOOL) {
                return val + " != 0";
            } else if ((field.value.type.enum_def && IsScalar(field.value.type.base_type)) || field.value.type.base_type == BASE_TYPE_BOOL) {
                return "static_cast<" + GenTypeBasic(field.value.type, from) + ">(" + val + ")";
            } else {
                return val;
            }
        }
        ...
        void GenMember(const FieldDef& field)
        {
            if (!field.deprecated && // Deprecated fields won't be accessible.
                field.value.type.base_type != BASE_TYPE_UTYPE && (field.value.type.base_type != BASE_TYPE_VECTOR || field.value.type.element != BASE_TYPE_UTYPE)) {
                ...
                if (opts_.g_cpp_std >= cpp::CPP_STD_11) {
                    ...
                    if (IsScalar(field.value.type.base_type)) {
                        field_di = " = " + (native_default ? std::string(native_default->constant) : GetDefaultScalarValue(field, true));
        ...
        bool NeedsCopyCtorAssignOp(const StructDef& struct_def)
        {
            for (const auto& field : struct_def.fields.vec) {
                ...
                if (type.base_type == BASE_TYPE_STRUCT) {
                    ...
                    const bool is_ptr = !(IsStruct(type) && field->native_inline) || (cpp_type && cpp_ptr_type->constant != "naked");
                    if (is_ptr) {
                        return true;
                    }
                    ...
                    if (IsScalar(field.value.type.base_type)) {
                        ...
                        if (IsStruct(field.value.type)) {
                            if (native_default) {
                                ...
                                initializer_list += Name(field) + "(" + native_default->constant + ")";
                            }
                        }
        ...
        void GenCopyMoveCtorAndAssigOpDecls(const StructDef& struct_def)
        {
            ...
            code_ += "  {{NATIVE_NAME}}({{NATIVE_NAME}}&&) FLATBUFFERS_NOEXCEPT = "
                     "default;";
            code_ += "  {{NATIVE_NAME}} &operator=({{NATIVE_NAME}} o) FLATBUFFERS_NOEXCEPT;";
        }
            ...
            for (const auto& field : struct_def.fields.vec) {
                ...
                if (type.base_type == BASE_TYPE_STRUCT) {
                    ...
                    if (is_ptr) {
                        ...
                        cw += "for (const auto &{{FIELD}}_ : o.{{FIELD}}) { "
                ...
                if (!field.deprecated && // Deprecated fields won't be accessible.
                    ...
                    if (struct_def.fixed || field.native_inline || field.value.type.base_type != BASE_TYPE_STRUCT) {
                        ...
                        if (IsVectorOfPointers(field)) {
                            const auto type = GenTypeNative(field.value.type.VectorType(), true, field);
                            const auto equal_length = lhs_accessor + ".size() == " + rhs_accessor + ".size()";
                            const auto elements_equal = "std::equal(" + lhs_accessor + ".cbegin(), " + lhs_accessor + ".cend(), " + rhs_accessor + ".cbegin(), [](" + type + " const &a, " + type + " const &b) { return (a == b) || (a && b && *a == *b); })";
                        ...
                        std::string both_null = "(" + lhs_accessor + " == " + rhs_accessor + ")";
                        std::string not_null_and_equal = "(lhs." + accessor + " && rhs." + accessor + " && *lhs." + accessor + " == *rhs." + accessor + ")";
        ...
        void GenOperatorNewDelete(const StructDef& struct_def)
        {
            if (auto native_custom_alloc = struct_def.attributes.Lookup("native_custom_alloc")) {
                ...
                code_ += "    return " + native_custom_alloc->constant + "<{{NATIVE_NAME}}>().deallocate(static_cast<{{NATIVE_NAME}}*>("
                                                                         "ptr),1);";
                code_ += "  }";
            }
        }
            ...
            const std::string rhs_struct_literal)
        {
            ...
            for (const auto& curr_field : struct_def.fields.vec) {
                ...
                if (curr_field->key) {
                    ...
                    code_ += space + "const auto {{CURR_FIELD_NAME}}_compare_result = "
                ...
                if (is_scalar) {
                    ...
                    code_ += space + "  return static_cast<int>({{LHS}} > {{RHS}}) - "
                    ...
                    if (IsScalar(elem_type.base_type)) {
                        ...
                        code_ += space + "    return static_cast<int>({{LHS}}_elem > {{RHS}}_elem) - "
        ...
        void GenKeyFieldMethods(const FieldDef& field)
        {
            ...
            if (is_string) {
                ...
                std::string input_type = "::flatbuffers::Array<" + GenTypeGet(elem_type, "", "", "", false) + ", " + NumToString(elem_type.fixed_length) + ">";
                code_.SetValue("INPUT_TYPE", input_type);
                code_ += "  int KeyCompareWithValue(const {{INPUT_TYPE}} *_{{FIELD_NAME}}"
                         ") const {";
                code_ += "    const {{INPUT_TYPE}} *curr_{{FIELD_NAME}} = {{FIELD_NAME}}();";
                code_ += "    for (::flatbuffers::uoffset_t i = 0; i < "
                ...
                if (IsScalar(elem_type.base_type)) {
                    ...
                    code_ += "      if (lhs != rhs)";
                    code_ += "        return static_cast<int>(lhs > rhs)"
                             " - static_cast<int>(lhs < rhs);";
                } else if (IsStruct(elem_type)) {
                    code_ += "      const auto &lhs_{{FIELD_NAME}} = "
                             "*(curr_{{FIELD_NAME}}->Get(i));";
                    code_ += "      const auto &rhs_{{FIELD_NAME}} = "
                             "*(_{{FIELD_NAME}}->Get(i));";
                ...
                if (opts_.scoped_enums && field.value.type.enum_def && IsScalar(field.value.type.base_type)) {
                    type = GenTypeGet(field.value.type, " ", "const ", " *", true);
                }
                // Returns {field<val: -1, field==val: 0, field>val: +1}.
                code_.SetValue("KEY_TYPE", type);
                code_ += "  int KeyCompareWithValue({{KEY_TYPE}} _{{FIELD_NAME}}) const {";
                code_ += "    return static_cast<int>({{FIELD_NAME}}() > _{{FIELD_NAME}}) - "
        ...
        void GenTableUnionAsGetters(const FieldDef& field)
        {
            ...
            for (auto u_it = u->Vals().begin(); u_it != u->Vals().end(); ++u_it) {
                ...
                code_.SetValue("U_ELEMENT_TYPE", WrapInNameSpace(u->defined_namespace, GetEnumValUse(*u, ev)));
        ...
        void GenTableFieldGetter(const FieldDef& field)
        {
            ...
            if (!field.IsScalarOptional()) {
                ...
                auto opt_value = "GetOptional<" + wire_type + ", " + face_type + ">(" + offset_str + ")";
        ...
        void GenStructFieldType(const FieldDef& field)
        {
            ...
            std::string field_type = GenTypeGet(field.value.type, "", is_array ? "" : "const ",
                is_array ? "" : " &", true);
        ...
        std::string GetNestedFlatBufferName(const FieldDef& field)
        {
            ...
            if (nested_root == nullptr) {
                qualified_name = parser_.current_namespace_->GetFullyQualifiedName(nested->constant);
            ...
            const std::string& field_size)
        {
            ...
            if (align > 1) {
                ...
                return "_fbb.ForceVectorAlignment(" + field_size + ", sizeof(" + type + "), " + std::to_string(static_cast<long long>(align)) + ");";
            }
            return "";
        }
                ...
                for (const auto& field : struct_def.fields.vec) {
                    if (!field->deprecated) {
                        ...
                        if (IsString(field->value.type)) {
                            ...
                            const std::string force_align_code = GenVectorForceAlign(*field, Name(*field) + "->size()");
                            ...
                            if (IsStruct(vtype)) {
                                ...
                                const auto type = GenTypeWire(vtype, "", VectorElementUserFacing(vtype));
            ...
            const char* vec_type_access)
        {
            ...
            return type_name + "Union::UnPack(" + "_e" + vec_elem_access + ", " + EscapeKeyword(afield.name + UnionTypeFieldSuffix()) + "()" + vec_type_access + ", _resolver)";
        }
            ...
            const FieldDef* union_field)
        {
            ...
            case BASE_TYPE_VECTOR: {
                ...
                if (!field.value.type.enum_def && !IsBool(field.value.type.element) && IsOneByte(field.value.type.element)) {
                    ...
                    code += "std::copy(_e->begin(), _e->end(), _o->" + name + ".begin()); }";
                } else {
                    std::string indexing;
                    if (field.value.type.enum_def) {
                        indexing += "static_cast<" + WrapInNameSpace(*field.value.type.enum_def) + ">(";
                    }
                    indexing += "_e->Get(_i)";
                    if (field.value.type.enum_def) {
                        indexing += ")";
                    ...
                    if (cpp_type) {
                        ...
                        if (is_pointer) {
                            code += "if(_o->" + name + "[_i]" + ") { ";
                            code += indexing + "->UnPackTo(_o->" + name + "[_i].get(), _resolver);";
                            code += " } else { ";
                        }
                        code += "_o->" + name + "[_i]" + access + " = ";
            ...
            default: {
                ...
                if (cpp_type) {
                    ...
                    if (is_pointer) {
                        code += " } } else if (" + out_field + ") { " + out_field + ".reset(); }";
                    }
                }
                break;
            }
            ...
            case BASE_TYPE_VECTOR: {
                ...
                case BASE_TYPE_STRING: {
                    if (NativeString(&field) == "std::string") {
                        ...
                        code += "_fbb.CreateVector<::flatbuffers::Offset<::flatbuffers::"
                                "String>>"
                                " ";
                        code += "(" + value + ".size(), ";
                ...
                case BASE_TYPE_STRUCT: {
                    if (IsStruct(vector_type)) {
                        ...
                        if (native_type) {
                            ...
                            code += WrapInNameSpace(*vector_type.struct_def) + ", " + native_type->constant + ">";
                            code += "(" + value;
                            const auto pack_name = struct_attrs.Lookup("native_type_pack_name");
                            if (pack_name) {
                ...
                case BASE_TYPE_UNION: {
                    code += "_fbb.CreateVector<::flatbuffers::"
                            "Offset<void>>("
                        + value + ".size(), [](size_t i, _VectorArgs *__va) { "
                                  "return __va->_"
                ...
                case BASE_TYPE_UTYPE: {
                    ...
                    code += "_fbb.CreateVector<" + type + ">(" + value + ".size(), [](size_t i, _VectorArgs *__va) { return " + enum_value + "; }, &_va)";
                    break;
                }
                default: {
                    if (field.value.type.enum_def && !VectorElementUserFacing(vector_type)) {
                        // For enumerations, we need to get access to the array data for
                        // the underlying storage type (eg. uint8_t).
                        const auto basetype = GenTypeBasic(
                            field.value.type.enum_def->underlying_type, false);
                        code += "_fbb.CreateVectorScalarCast<" + basetype + ">(::flatbuffers::data(" + value + "), " + value + ".size())";
                    } else if (field.attributes.Lookup("cpp_type")) {
                ...
                if (field.attributes.Lookup("nested_flatbuffer") || (opts_.set_empty_vectors_to_null && !field.IsRequired())) {
        ...
        void GenTablePost(const StructDef& struct_def)
        {
            ...
            if (opts_.generate_object_based_api) {
                ...
                code_ += "inline " + TableUnPackSignature(struct_def, false, opts_) + " {";
                ...
                if (opts_.g_cpp_std == cpp::CPP_STD_X0) {
                    ...
                    code_.SetValue("POINTER_TYPE",
                        GenTypeNativePtr(native_name, nullptr, false));
                    code_ += "  {{POINTER_TYPE}} _o = {{POINTER_TYPE}}(new {{NATIVE_NAME}}());";
                ...
                code_ += "}";
                code_ += "";
                code_ += "inline " + TableUnPackToSignature(struct_def, false, opts_) + " {";
                code_ += "  (void)_o;";
                ...
                for (auto it = struct_def.fields.vec.begin();
                    ...
                    const auto statement = GenUnpackFieldStatement(field, is_union ? *(it + 1) : nullptr);
                ...
                code_ += "inline " + TableCreateSignature(struct_def, false, opts_) + " {";
                code_ += "  (void)_rehasher;";
                code_ += "  (void)_o;";
                ...
                code_ += "  struct _VectorArgs "
                         ...
                         "const "
                    + NativeName(Name(struct_def), &struct_def, opts_) + "* __o; "
                ...
                for (auto it = struct_def.fields.vec.begin();
                    ...
                    if (IsVector(field.value.type)) {
                        const std::string force_align_code = GenVectorForceAlign(field, "_o->" + Name(field) + ".size()");
                        if (!force_align_code.empty()) {
                ...
                for (const auto& field : struct_def.fields.vec) {
                    ...
                    if (field->value.type.base_type == BASE_TYPE_STRUCT) {
                        if (IsStruct(field->value.type)) {
                            auto native_type = field->value.type.struct_def->attributes.Lookup("native_type");
                            if (native_type) {
        ...
        {
            *code_ptr += "  int" + NumToString(bits) + "_t padding" + NumToString((*id)++) + "__;";
        }
            ...
            if (!arg_list.empty()) {
                ...
                for (const auto& field : struct_def.fields.vec) {
                    ...
                    if (IsArray(type) && init_arrays) {
                        ...
                        FLATBUFFERS_ASSERT(
                            (IsScalar(element_type.base_type) || IsStruct(element_type)) && "invalid declaration");
                        const auto face_type = GenTypeGet(type, " ", "", "", is_enum);
                        std::string get_array = is_enum ? "CastToArrayOfEnum<" + face_type + ">" : "CastToArray";
                        const auto field_name = Name(*field) + "_";
                        const auto arg_name = "_" + Name(*field);
                        code_ += "    ::flatbuffers::" + get_array + "(" + field_name + ").CopyFromSpan(" + arg_name + ");";
                    }
                    if (field->padding) {
                        std::string padding;
        ...
        void GenArrayAccessor(const Type& type, bool mutable_accessor)
        {
            ...
            const auto face_type = GenTypeGet(type, " ", "", "", is_enum);
            std::string ret_type = "::flatbuffers::Array<" + face_type + ", " + NumToString(type.fixed_length) + ">";
            if (mutable_accessor)
        ...
        void GenStruct(const StructDef& struct_def)
        {
            ...
            for (const auto& field : struct_def.fields.vec) {
                ...
                auto value = is_scalar ? "::flatbuffers::EndianScalar(" + member + ")" : member;
                ...
                if (opts_.mutable_buffer) {
                    auto mut_field_type = GenTypeGet(type, " ", "", is_array ? "" : " &", true);
        ...
        void SetNameSpace(const Namespace* ns)
        {
            ...
            while (common_prefix_size < old_size && common_prefix_size < new_size && ns->components[common_prefix_size] == cur_name_space_->components[common_prefix_size]) {
                common_prefix_size++;
            }
    ...
    const std::string& file_name)
{
    ...
    if (cpp_std == "C++0X") {
        ...
        LogCompilerError("Unknown value of the '--cpp-std' switch: " + opts.cpp_std);
        return false;
    }
    ...
    const std::string& file_name)
{
    ...
    std::string make_rule = geneartor.GeneratedFileName(path, filebase, parser.opts) + ": ";
