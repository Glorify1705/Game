...
namespace lua {
    ...
    public:
        ...
        {
            return std::string(Indent) + "local o = " + SelfData + ":Offset(" + NumToString(field.value.offset) + ")\n" + Indent + "if o ~= 0 then\n";
        }
        ...
        {
            std::string& code = *code_ptr;
            code += std::string(Indent) + NormalizedName(ev) + " = " + enum_def.ToString(ev) + ",\n";
        }
            ...
            std::string* code_ptr)
        {
            ...
            //  "\n";
            //}
            code += std::string(Indent) + Indent + "local obj = "
        ...
        {
            std::string& code = *code_ptr;
            code += "function " + NormalizedName(struct_def) + ".Add" + ConvertCase(NormalizedName(field), Case::kUpperCamel);
            code += "(builder, ";
            code += ConvertCase(NormalizedName(field), Case::kLowerCamel);
            code += ") ";
            ...
            if (IsScalar(field.value.type.base_type)) {
                ...
                case BASE_TYPE_VECTOR: {
                    ...
                    if (vectortype.base_type == BASE_TYPE_STRUCT) {
                        ...
                        if (vectortype.base_type == BASE_TYPE_CHAR || vectortype.base_type == BASE_TYPE_UCHAR) {
        ...
        std::string GenGetter(const Type& type)
        {
            ...
            default:
                return std::string(SelfData) + ":Get(flatbuffers.N." + ConvertCase(GenTypeGet(type), Case::kUpperCamel) + ", ";
            }
        }
    ...
    private:
            ...
            bool needs_imports)
        {
            ...
            std::string filename = NamespaceDir(*def.defined_namespace) + NormalizedName(def) + ".lua";
