 ...
 * List of hashes
 * ==================================================
 * Each hash must be wrapped in a thin redirector conformant with the
 * BMK_benchfn_t. BMK_benchfn_t is generic, not specifically designed for
 * hashes. For hashes, the following parameters are expected to be useless: dst,
 * dstCapacity, customPayload.
 *
...
size_t rapidhash_wrapper(const void* src, size_t srcSize, void* dst,
...
size_t rapidhashMicro_wrapper(const void* src, size_t srcSize, void* dst,
                              size_t dstCapacity, void* customPayload) {
  (void)dst;
  (void)dstCapacity;
  (void)customPayload;
...
size_t rapidhashNano_wrapper(const void* src, size_t srcSize, void* dst,
                             size_t dstCapacity, void* customPayload) {
  (void)dst;
  (void)dstCapacity;
  (void)customPayload;
...
size_t xxh3_wrapper(const void* src, size_t srcSize, void* dst,
                    size_t dstCapacity, void* customPayload) {
  (void)dst;
  (void)dstCapacity;
  (void)customPayload;
...
Bench_Entry const hashCandidates[NB_HASHES] = {
    ...
    {"xxh3", xxh3_wrapper},
#ifdef HARDWARE_SUPPORT
/* list here codecs which require specific hardware support, such SSE4.1,
 * PCLMUL, AVX2, etc. */
#endif
};
