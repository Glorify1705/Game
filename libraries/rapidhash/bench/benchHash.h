 ...
 * total_time_ms: time spent benchmarking the hash function with given
 * parameters iter_time_ms: time spent for one round. If multiple rounds are
 * run, bench_hash() will report the speed of best round.
 */
