...
typedef unsigned long long
    PTime; /* does not support compilers without long long support */
#endif
...
#define UTIL_TIME_INITIALIZER 0
    ...
    defined(TIME_UTC) /* C11 requires timespec_get, but FreeBSD 11 lacks it, \
                         while still claiming C11 compliance */
