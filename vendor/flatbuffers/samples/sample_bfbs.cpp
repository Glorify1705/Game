...
int main(int /*argc*/, const char* /*argv*/[])
{
    ...
    bool ok = flatbuffers::LoadFile("tests/monster_test.fbs", false, &schema_file) && flatbuffers::LoadFile("tests/monsterdata_test.golden", false, &json_file) && flatbuffers::LoadFile("tests/monster_test.bfbs", true, &bfbs_file);
    if (!ok) {
