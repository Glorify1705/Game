...
function Game:draw()
	...
	-- Multi-color text (no wrapping).
	G.graphics.set_color("skyblue")
	G.graphics.draw_text(FONT, SIZE, "Multi-color text:", 20, y)
	y = y + 30

	G.graphics.draw_text_colored(FONT, SIZE, {
		{ 255, 255, 255, 255 },
		"Normal ",
		{ 255, 80, 80, 255 },
		"red ",
	...
	-- Multi-color wrapped text.
	G.graphics.set_color("skyblue")
	G.graphics.draw_text(FONT, SIZE, "Multi-color wrapped (center):", 20, y)
	y = y + 30

	G.graphics.set_color(40, 40, 60, 180)
	G.graphics.draw_rect(20, y, 20 + WRAP_WIDTH, y + 80)
	G.graphics.draw_text_colored(FONT, SIZE, {
		{ 255, 255, 255, 255 },
		"The quick ",
		{ 255, 100, 50, 255 },
		...
		"lazy dog. ",
		{ 180, 255, 180, 255 },
		"This demonstrates multi-color word-wrapped text with center alignment.",
	}, 20, y, WRAP_WIDTH, "center")
	y = y + 100
