...
function Game:draw()
    ...
    G.graphics.draw_triangle(
        col_w * 2 + pad, row_h - pad,
        col_w * 2.5, y1 + pad,
        col_w * 3 - pad, row_h - pad
    )
    ...
    G.graphics.draw_rect_outline(
        pad, y_off + label_h + pad,
        col_w - pad, y_off + row_h - pad
    )
    ...
    G.graphics.draw_triangle_outline(
        col_w * 2 + pad, y_off + row_h - pad,
        col_w * 2.5, y_off + label_h + pad,
        col_w * 3 - pad, y_off + row_h - pad
    )
