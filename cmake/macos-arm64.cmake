# CMake toolchain file for cross-compiling to macOS arm64 (Apple Silicon)
# using osxcross.
#
# Usage:
#   scripts/setup-osxcross-toolchain.sh   # one-time setup
#   cmake -G Ninja -S . -B build-macos \
#     -DCMAKE_TOOLCHAIN_FILE=cmake/macos-arm64.cmake
#   ninja -C build-macos
...
# Find the target triple (e.g. arm64-apple-darwinXX).
file(GLOB _CLANGXX "${_OSXCROSS_ROOT}/bin/arm64-apple-darwin*-clang++")
list(LENGTH _CLANGXX _CLANG_COUNT)
if(_CLANG_COUNT EQUAL 0)
  message(FATAL_ERROR
    "osxcross arm64 clang++ not found at ${_OSXCROSS_ROOT}/bin/\n"
    "Run: scripts/setup-osxcross-toolchain.sh")
endif()
